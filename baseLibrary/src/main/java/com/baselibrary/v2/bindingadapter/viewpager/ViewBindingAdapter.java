package com.baselibrary.v2.bindingadapter.viewpager;
...
import com.baselibrary.v2.weight.navigation.AHBottomNavigationViewPager;
...
public class ViewBindingAdapter {
    ...
    public static void init(final ViewPager viewPager, final FragmentManager fragmentManager, List<Fragment> items, List<String> titles) {
        ...
        v2.bindingadapter.viewpager.ViewPagerFragmentAdatper adatper;
        if (titles == null) {
            adatper = new v2.bindingadapter.viewpager.ViewPagerFragmentAdatper(fragmentManager, items);
        } else {
            adatper = new v2.bindingadapter.viewpager.ViewPagerFragmentAdatper(fragmentManager, items, titles);
        }
