package com.baselibrary.v2.utils.inject;
...
public class InjectUtil {
    ...
    public static void injectRootView(Activity activity) {
        ...
        if (clazz.isAnnotationPresent(v2.utils.inject.RootView.class)) {
            v2.utils.inject.RootView rootView = clazz.getAnnotation(v2.utils.inject.RootView.class);
    ...
    private static void injectAfterView(Object object, Method[] methods) {
        ...
        if (methods != null && methods.length > 0) {
            for (Method method : methods) {
                if (method.isAnnotationPresent(v2.utils.inject.AfterViews.class)) {
                    try {
                        method.setAccessible(true);
    ...
    private static void injectBeforeView(Object object, Method[] methods) {
        ...
        if (methods != null && methods.length > 0) {
            for (Method method : methods) {
                if (method.isAnnotationPresent(v2.utils.inject.BeforeViews.class)) {
                    try {
                        method.setAccessible(true);
                        method.invoke(object, new Object[0]);
                    } catch (Exception e) {
