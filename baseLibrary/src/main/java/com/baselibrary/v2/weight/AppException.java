package com.baselibrary.v2.weight;
...
import com.baselibrary.v2.utils.DateUtil;
import com.baselibrary.v2.utils.FileUtil;
...
public class AppException extends Exception implements UncaughtExceptionHandler {
    ...
    public final static byte TYPE_HTTP_FAIL = 0x11;
    ...
    public final static byte TYPE_INJECT = 0x10;
    public final static byte TYPE_BINDING = 0x11;
    ...
    public static AppException http(String message) {
        return new AppException(TYPE_HTTP_FAIL, 0, new Exception(message));
    }
    ...
    public static AppException inject(Exception e) {
        return new AppException(TYPE_INJECT, 0, e);
    }

    public static AppException binding(Exception e) {
        return new AppException(TYPE_BINDING, 0, e);
    }
...
//                        UIHelper.sendAppCrashReport(context);
    ...
    private boolean saveToSDCard(Throwable ex) throws Exception {
        ...
        File file = FileUtil.getSaveFile("debugLog", "opcore.log");
        ...
        PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(
                file, append)));
        // 导出发生异常的时间
        pw.println(DateUtil.getCurrentTime("yyyy-MM-dd-HH-mm-ss"));
        // 导出手机信息
        dumpPhoneInfo(pw);
        pw.println();
        // 导出异常的调用栈信息
