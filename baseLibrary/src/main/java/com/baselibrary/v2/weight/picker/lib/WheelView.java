...
import com.baselibrary.v2.weight.picker.adapter.WheelAdapter;
...
import v2.weight.picker.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.app_text_xlarge);
        customTextSize = true;
        if (attrs != null) {
